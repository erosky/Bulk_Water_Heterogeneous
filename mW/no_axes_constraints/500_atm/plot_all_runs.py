...
# data: RUN TEMP
temperature_file = 'analysis/freeze_temperatures_500atm.dat'
...
all_runs_plot = 'analysis/all_runs_500atm.png'

plt.figure(1)
plt.xlim(225,210)
plt.ylim(0,1.0)
plt.title('Heterogeneous freezing on graphite at -500 atm, mW Model, 0.25 K/ns')
...
# plot gradients
all_gradients_plot = 'analysis/all_gradients_500atm.png'
