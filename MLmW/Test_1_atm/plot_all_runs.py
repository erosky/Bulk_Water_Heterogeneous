...
# data: RUN TEMP
temperature_file = 'analysis/freeze_temperatures_1atm.dat'
...
all_runs_plot = 'analysis/all_runs_1atm.png'

plt.figure(1)
plt.xlim(225,210)
plt.ylim(0,1.0)
plt.title('Heterogeneous freezing on graphite at 1 atm, mW Model, 0.25 K/ns')
...
# plot gradients
all_gradients_plot = 'analysis/all_gradients_1atm.png'
