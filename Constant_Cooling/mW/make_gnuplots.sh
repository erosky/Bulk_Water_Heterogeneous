...
run=$1
start=46 #41 for nvt
end=160046 #120045 for 1000atm #160041
logfile="./run_${run}/log.run_homog_freeze_${run}"
...
gnuplot -e "set terminal png size 1000,600; \
            ...
            set title 'Potential Energy - mW, ${pres}'; \
            set ylabel 'kJ/mol'; \
...
gnuplot -e "set terminal png size 1000,600; \
            ...
            set title 'Total Energy - mW, ${pres}'; \
            set ylabel 'kJ/mol'; \
            set xlabel 'Temperature (K)'; \
            set style data lines; \
            set xrange [${Tstart}:${Tend}] reverse; \
...
gnuplot -e "set terminal png size 1000,600; \
            ...
            set title 'Potential Energy - mW, Sim ${pres}'; \
            set ylabel 'Angstroms'; \
            set xlabel 'Temperature (K)'; \
            set style data lines; \
            set xrange [${Tstart}:${Tend}] reverse; \
...
gnuplot -e "set terminal png size 1000,600; \
            ...
            set title 'Box Volume - mW, Sim ${pres}'; \
            set ylabel 'Cubic Angstroms'; \
            set xlabel 'Temperature (K)'; \
            set style data lines; \
            set xrange [${Tstart}:${Tend}] reverse; \
