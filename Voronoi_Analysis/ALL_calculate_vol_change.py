...
for r in np.arange(1000,2000+250,250):
	
	data_file = f"MLmW_1atm/liquid/liquid_{r}.xyz"
...
for r in np.arange(7000,8000+250,250):
	
	data_file = f"MLmW_1atm/ice/ice_{r}.xyz"
	data = np.loadtxt(data_file)
	data = data[2:]
	data = np.transpose(data)
	x = data[0]
