...
%DIF DEL Draft/main.tex      Tue Feb 21 14:23:25 2023
%DIF ADD Revision/main.tex   Wed Feb 22 02:19:46 2023
...
Simulations of water in capillary bridges confirm that negative Laplace pressure within the water corresponds to an increase in heterogeneous freezing temperature. The freezing temperature in the water capillary bridges increases linearly with inverse capillary height ($1/h$). Varying the height and width of the capillary bridge reveals the role of geometric factors in heterogeneous ice nucleation. When substrate surfaces are separated by less than approximately $h$ = 20 \AA{} the nucleation rate is enhanced and when the width of the capillary bridge is less than approximately 30 \AA{} the nucleation rate is suppressed. Ice nucleation does not occur in the region within 10 \AA{} of the air-water interface and shows a preference for nucleation in the region just beyond 10 \AA{}.
...
\noindent The governing quantities are the equilibrium melting point ($T_m$), the specific-volume difference between liquid and solid water, i.e., the density anomaly (\DIFdelbegin \DIFdel{$\Delta v_{ls}$}\DIFdelend \DIFaddbegin \DIFadd{$\Delta \nu_{ls}$}\DIFaddend ), and the enthalpy of fusion (also known as latent heat, $l_f$) --- all evaluated at a reference pressure of 1 atmosphere. A thorough derivation of this expression can be found in the appendix of \citet{rosky2022}, using the pressure-dependent formulation of the solid-liquid chemical potential difference ($\mu$) formulated by \citet{nemec2013} combined with classical nucleation theory for $j_{hom}$ \citep[see also][]{yang2018}. \DIFaddbegin \DIFadd{According to this approximation, the slope of $\Delta T/\Delta P$ is parallel to the liquid-solid phase coexistence line, given by the Clapeyron equation. Detailed studies support that the slope of homogeneous freezing lines is not actually parallel to the melting point line \mbox{%DIFAUXCMD
\citep{bianco2021, espinosa2016}}\hspace{0pt}%DIFAUXCMD
, but \mbox{%DIFAUXCMD
\citet{rosky2022} }\hspace{0pt}%DIFAUXCMD
has shown that, as an approximation, it holds true for pressures ranging from 1 atm to -1000 atm. }\DIFaddend In the present study we ask: Does the heterogeneous ice nucleation rate follow a similar expression for pressure dependence as the homogeneous ice nucleation rate? And do simple geometric arrangements leading to negative Laplace pressure indeed result in similar behavior?
...
%DIFDELCMD < \includegraphics[width=12cm]{figures/configurations.png}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{fig:configurations} %%%
...
We observe that a simulation box containing 4,096 mW water molecules at 1 atm with no substrate \DIFdelbegin \DIFdel{(a volume of roughly 125 nm$^3$) }\DIFdelend freezes homogeneously at an average temperature of 202 K when cooled at a constant rate of 0.25 K ns$^{-1}$. After inserting a layer of substrate into the center of this same volume of water (as in Fig. \ref{fig:configurations}(a)) and using the same cooling rate, we observe that heterogeneous freezing on the substrate takes place at an average temperature of 217.5 K, a 15.5 K increase over the homogeneous freezing temperature. This is consistent with the results of \citet{lupi2014}, who reported a 12$\pm$3 K difference between heterogeneous and homogeneous freezing temperature when cooling at a rate of 1 K ns$^{-1}$.

Our previous study \citep{rosky2022} indicates that the MLmW water model is more appropriate for studying pressure effects on ice nucleation because it exhibits a density anomaly that is closer to real water \citep{chan2019}. Therefore, in order to increase the ability to translate our findings onto real water droplets, we focus our study on the MLmW model instead of mW. We define a substrate interaction potential for the MLmW model that is a modified version of the \DIFdelbegin \DIFdel{Carbon-mW }\DIFdelend \DIFaddbegin \DIFadd{mW-Carbon }\DIFaddend interaction potential defined by \citet{lupi2014}. We adjust the parameters of the interaction potential to form a potential between the substrate and MLmW water that is hydrophilic and stable within the range of negative pressures that we study. The resulting interaction parameters used in this work are summarized in Table \ref{Tab:potentials}.

In selecting interaction parameters for the substrate, we are not attempting to exactly model the properties of \DIFdelbegin \DIFdel{carbon-water }\DIFdelend \DIFaddbegin \DIFadd{water-carbon }\DIFaddend interaction or reproduce the \DIFdelbegin \DIFdel{Carbon-mW interaction potential }\DIFdelend \DIFaddbegin \DIFadd{mW-Carbon interaction potential for the MLmW model}\DIFaddend . However, we did select a potential that exhibits a similar difference between heterogeneous and homogeneous freezing temperature as shown by the mW model. A simulation box containing 4,096 MLmW water molecules at 1 atm freezes homogeneously at an average temperature of 214.5 K when cooled at a constant rate of 0.25 K ns$^{-1}$. With the substrate inserted, the average heterogeneous freezing temperature on this substrate is 228.5 K, a change in temperature of 14 K. 

\DIFdelbegin \DIFdel{Upon visual inspection, the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend resulting interaction potential between MLmW and substrate has a contact angle \DIFdelbegin \DIFdel{smaller that }\DIFdelend \DIFaddbegin \DIFadd{between water and substrate that is smaller than }\DIFaddend that of the \DIFdelbegin \DIFdel{Carbon-mW }\DIFdelend \DIFaddbegin \DIFadd{mW-Carbon }\DIFaddend potential, which was tuned by \citet{lupi2014} to have a contact angle of 86 degrees. This smaller contact angle is consistent with \DIFdelbegin \DIFdel{the methods used by \mbox{%DIFAUXCMD
\citet{Bi2016} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet{Bi2016} }\hspace{0pt}%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citet{lupi2014hydrophilicity}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend , where the \DIFdelbegin \DIFdel{Carbon-mW interaction potential was }\DIFdelend \DIFaddbegin \DIFadd{interaction potential is }\DIFaddend adjusted in a similar manner as here to \DIFdelbegin \DIFdel{increase }\DIFdelend \DIFaddbegin \DIFadd{modify }\DIFaddend the substrates hydrophilicity. Our estimate of the MLmW-Substrate contact angle is 50.5 degrees and will be discussed in Sec. \ref{capillary}.
...
We can now use the linear slope $-2 \sigma_{lv}\cos(\theta) \left[\frac{\Delta \nu_{ls} T_m }{l_f}\right]$ from Eq. (\ref{eq:dTh}) to analyze the results in Fig. \ref{fig:capillary}. A linear fit to \DIFdelbegin \DIFdel{our data points gives a slope }\DIFdelend \DIFaddbegin \DIFadd{the data points in Fig. \ref{fig:capillary} produces a slope $(\Delta T \cdot h)$ }\DIFaddend of $9.3$ K$\cdot$m. We also know from our analysis of $(\Delta T/\Delta P)$ in Sec. \ref{sec:hetrate} \DIFaddbegin \DIFadd{and Table \ref{tab:slopes} }\DIFaddend that the best fit value of $\left[\frac{\Delta \nu_{ls} T_m }{l_f}\right]$ for the MLmW model is $-0.14$ K MPa$^{-1}$. We \DIFdelbegin \DIFdel{use }\DIFdelend \DIFaddbegin \DIFadd{substitute }\DIFaddend these two slopes \DIFaddbegin \DIFadd{into Eq. (\ref{eq:dTh}) }\DIFaddend to solve for the value $\sigma_{ls} cos(\theta) = 0.042$ J m$^{-2}$. The surface tension $\sigma_{ls}$ of the mW model was reported by \citet{molinero2009} to be $0.066$ J m$^{-2}$, and by following methods of \citet{li2009surface} (supplementary material), we found the same value for the MLmW model. Using this value of $\sigma_{ls}$, we \DIFdelbegin \DIFdel{arrive at a contact angle value of }\DIFdelend \DIFaddbegin \DIFadd{solve for the contact angle }\DIFaddend $\theta = 50.5$ degrees\DIFdelbegin \DIFdel{, which }\DIFdelend \DIFaddbegin \DIFadd{. This value of $\theta$ }\DIFaddend is consistent with \DIFdelbegin \DIFdel{an estimate from the simulation data. Using our estimate }\DIFdelend \DIFaddbegin \DIFadd{estimates we obtain by measuring the radius of curvature of the capillary bridge air-water interfaces using a method similar to \mbox{%DIFAUXCMD
\citet{giovambattista2007}}\hspace{0pt}%DIFAUXCMD
. With these estimates }\DIFaddend of $\sigma_{ls}$ and $\theta$, we can also use Eq. (\ref{eq:dPh}) to calculate the magnitude of Laplace pressure that may be present within the water capillary bridges. The 24-\AA{} capillary bridge has a pressure of $-345$ atm, and the 30-\AA{} bridge a pressure of $-275$ atm.
...
\DIFaddbegin \DIFadd{Suppression of ice nucleation has been noted by \mbox{%DIFAUXCMD
...
found that for the more detailed TIP4P/ice model, ice nucleation was suppressed within 10 \AA{} of the air-water interface, and also showed evidence of higher ice nucleation rates near the interface compared to in the bulk.
}
...
In creating a suitable interaction potential for an interaction between MLmW water and the substrate, we start with the MLmW-MLmW parameters and\DIFaddbegin \DIFadd{, as in the methods of \mbox{%DIFAUXCMD
\citet{fitzner2015facets}}\hspace{0pt}%DIFAUXCMD
, only }\DIFaddend the $\epsilon$ and $\sigma$ values are \DIFdelbegin \DIFdel{the only parameters that were adjusted }\DIFdelend \DIFaddbegin \DIFadd{adjusted to produce our MLmW-Substrate interaction}\DIFaddend . Given that the value of $\epsilon$ we have used is larger than that of the \DIFdelbegin \DIFdel{Carbon-mW }\DIFdelend \DIFaddbegin \DIFadd{mW-Carbon }\DIFaddend interaction, the smaller contact angle that we see for MLmW-Substrate is consistent with \citet{Bi2016} \DIFaddbegin \DIFadd{and \mbox{%DIFAUXCMD
\citet{cox2015hydrophilicity}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend , where higher values of $\epsilon$ were used to increase hydrophilicity of the Carbon-mW interaction potential \cite{Bi2016}.
...
} %DIF > % this section is mandatory

\competinginterests{No competing interests are present} %DIF > % this section is mandatory even if you declare that no competing interests are present
\DIFaddend 
